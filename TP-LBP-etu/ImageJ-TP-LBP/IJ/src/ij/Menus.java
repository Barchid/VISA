...
public class Menus {
	...
	// lo: changé 5 en 6 pour ajouter la macro "Close all without saving" dans ce menu Window
	...
	String addMenuBar() {
		...
		// lo: ajouté la macro "Close all without saving" dans ce menu Window
		addItem(window, "Close All Windows", KeyEvent.VK_EXCLAMATION_MARK, true);
