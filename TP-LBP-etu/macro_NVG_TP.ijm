...
========
========	Macro_NVG_TP.ijm
========	Macro ImageJ exemple de classification des images de la base Outex-TC-000xx
========  Le descripteur utilisé est le LBP de la luminance.
======== Macro pour le TP M2 IVI séance 3
======== 20 nov. 2018
...
result_dir_root = execution_dir+File.separator+"Resultats";
